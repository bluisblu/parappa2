 ...
 */
/* $Id: excepman.h,v 1.2 1999/10/12 09:06:47 tei Exp $ */
...
extern int RegisterExceptionHandler(int excode, void (*handler)());
extern int RegisterPriorityExceptionHandler(int excode,
				     int priority, void (*handler)());
extern int RegisterDefaultExceptionHandler(void (*handler)());

extern int ReleaseExceptionHandler(int excode, void (*handler)());
extern int ReleaseDefaultExceptionHandler(void (*handler)());
#endif
