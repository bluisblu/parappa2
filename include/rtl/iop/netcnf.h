 ...
 *                          net - netcnf.h
 *
 * $Id: netcnf.h,v 1.9 2001/10/26 06:01:59 tetsu Exp $
 */
...
typedef struct sceNetCnfCommand {
	...
	int code;
	// struct sceNetCnfAddress address; 	/* {ADD,DEL}_NAMESERVER */
	// struct sceNetCnfRoutingEntry routing;/* {ADD,DEL}_ROUTING */
} sceNetCnfCommand_t;
...
typedef struct sceNetCnfUnknown {
	...
	// u_char unknown_keyword_and_argument[0];
} sceNetCnfUnknown_t;
...
#define sceNetCnf_CURRENT_VERSION	2
