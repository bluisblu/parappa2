 ...
 *                    Sep,20,2000     kaneko
 */
/*	$Id: libhig.h,v 1.24 2001/10/29 05:40:55 kaneko Exp $	*/
#ifndef __HiG_H__
#define __HiG_H__
#ifdef __cplusplus
extern "C" {
...
typedef enum {
	...
	SCE_HIG_REPOSITORY_M	=	((u_long)0x00000000000000ff),
	SCE_HIG_PROJECT_M	=	((u_long)0x000000000000ff00),
	SCE_HIG_CATEGORY_M	=	((u_long)0x0000000000ff0000),
	SCE_HIG_STATUS_M	=	((u_long)0x00000000ff000000),
	SCE_HIG_ID_M	=		((u_long)0x00ffffff00000000),
	SCE_HIG_REVISION_M	=	((u_long)0xff00000000000000)
} sceHiTypeMask;
...
**/
/*      default plugins process                 */
#define INIT_PROCESS            SCE_HIG_INIT_PROCESS
#define PRE_PROCESS             SCE_HIG_PRE_PROCESS
#define POST_PROCESS            SCE_HIG_POST_PROCESS
#define END_PROCESS             SCE_HIG_END_PROCESS

/* default converter variables */
#define HEADER_STATUS           SCE_HIG_HEADER_STATUS
#define PLUGIN_STATUS           SCE_HIG_PLUGIN_STATUS
#define DATA_STATUS             SCE_HIG_DATA_STATUS
...
#define SCE_HIGS_PAGE_SIZE	(8*1024)	/* byte size */
#define SCE_HIGS_BLOCK_SIZE	(256)		/* byte size */
#define SCE_HIGS_COLUMN_SIZE	(64)		/* byte size */

#define SCE_HIGS_PAGE_ALIGN	(SCE_HIGS_PAGE_SIZE/4)		/* 2K word */
#define	SCE_HIGS_BLOCK_ALIGN	(SCE_HIGS_BLOCK_SIZE/4)		/* 64 word */
#define	SCE_HIGS_COLUMN_ALIGN	(SCE_HIGS_COLUMN_SIZE/4)	/* 16 word */
...
typedef enum _sceHiGsEnvValidRegs_t {  /* sceHiGsGeneral と同じならび順 */
	...
	SCE_HIGS_VALID_TRXDIR=(1L<<15),
	SCE_HIGS_VALID_SIGNAL=(1L<<16),
	SCE_HIGS_VALID_FINISH=(1L<<17),
	SCE_HIGS_VALID_LABEL=(1L<<18)
