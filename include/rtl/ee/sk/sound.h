...
#define sceSkSsBindNote(id,a,b)		sceSkSsMSIN_Bind(SCESK_SQ,(id))
...
#if defined(__VA_ARGS__)	/* C99 */
#define sceSkSsBind(f,d,...)		sceSkSs##f##_Bind(SCESK_##d,__VA_ARGS__)
#define sceSkSsUnbind(f,d,...)		sceSkSs##f##_Bind(SCESK_##d,__VA_ARGS__)
...
#define sceSkSsVoiceSetPitchbend(tid,id,ch,n,p)  sceSkSsVoiceSetPitchBend(tid,id,ch,n,p)
...
#define sceSkSsStatusSONG(id,c) sceSkSsMIDI_Status((id),(c))
