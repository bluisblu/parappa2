...
extern int  sceDevctl (const char *devname, int cmd, 
	      void *arg, unsigned int arglen, void *bufp, unsigned int buflen);
...
extern int  sceIoctl2(int fd, int request, void *argp, unsigned int arglen,
...
#define IOP_IMAGE_FILE "IOPRP242.IMG"
#define IOP_IMAGE_file "ioprp242.img"
